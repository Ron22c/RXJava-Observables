...
public class RXUtils {
     ...
     * @return
     */
    public static List<Shapes> shapes(Integer n){
        //List to hold shapes of size n
        List<Shapes> shapes= new ArrayList<>(n);
        for(int i=1;i<=n;i++){
            shapes.add(new Shapes(randomShape(),randomColor()));
        }
        return shapes;
